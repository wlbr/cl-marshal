...
baseclasses. This methid must reside in the package :marshal! It has
to reurn a list of slotnames. These slots will be serialized.
...
name and the slotnames listed in  `ms:class-persistant-slots` have to
